...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Create New Supir</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Create Supir Form</h6>
        </div>
        <div class="card-body">
            <form method="post">
                <div class="form-group">
                    <label for="kode"><strong>Kode</strong></label>
                    <input type="text" name="kode" placeholder="Masukkan Kode" autocomplete="off" class="form-control" required value="SPR<?= mt_rand(100, 999) ?>" maxlength="8" readonly>
                </div>
                <div class="form-group">
