...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Barang Form</h6>
        </div>
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="kondisi" name="kondisi" required>
                        ...
                        <option value="baik" <?= 'baik' == $barang['kondisi'] ? 'selected' : '' ?>>Baik</option>
                        <option value="rusak" <?= 'rusak' == $barang['kondisi'] ? 'selected' : '' ?>>Rusak</option>
