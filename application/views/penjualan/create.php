...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Create New Penjualan</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Create Penjualan Form</h6>
        </div>
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" min="1" id="jumlah_keluar" name="jumlah_keluar" value="<?= set_value('jumlah_keluar') ?>" required>
                </div>
                <div class="form-group">
