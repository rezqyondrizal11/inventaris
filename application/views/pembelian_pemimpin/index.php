...
<div class="container-fluid">
    ...
    <a href="<?= site_url('pembelian_pemimpin/print_pdf?start_date=' . $this->input->get('start_date') . '&end_date=' . $this->input->get('end_date')) ?>" class="btn btn-danger mb-4" target="_blank">Print PDF</a>
    <a href="<?= site_url('pembelian_pemimpin/export_excel') ?>?start_date=<?= $this->input->get('start_date') ?>&end_date=<?= $this->input->get('end_date') ?>"
        class="btn btn-success mb-4">Export Excel</a>
    <!-- Filter Form -->
    <form method="GET" action="<?= site_url('pembelian_pemimpin') ?>" class="mb-4">
        <div class="form-row">
            <div class="col-md-4">
